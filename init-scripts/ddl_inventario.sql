...
CREATE INDEX idx_movimiento_tipo ON public.movimiento USING btree (tipo_movimiento);
...
CREATE INDEX idx_producto_categoria_id ON public.producto USING btree (categoria_id);
...
CREATE INDEX idx_detalle_movimiento_movimiento_id ON public.detalle_movimiento USING btree (movimiento_id);
CREATE INDEX idx_detalle_movimiento_producto_id ON public.detalle_movimiento USING btree (producto_id);
